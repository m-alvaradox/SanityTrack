import { Bell, Building2, History, LayoutDashboard, Radio, X } from 'lucide-react'
...
export default function Sidebar({ open, onClose }) {
  return <aside className={`sidebar ${open ? 'open' : ''}`}>
    <div className="brand"><img className="brand-logo" src="/logo.svg" alt="Sanity Track" /><button className="icon-button sidebar-close" onClick={onClose} aria-label="Cerrar menú"><X /></button></div>
